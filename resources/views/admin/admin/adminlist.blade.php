@include('admin.public.head')
	...
	<div class="page-content">
        ...
        <!-- Page Body -->
        <div class="page-body">
        	<a href="{{url('admin/addadmin')}}" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i>&nbsp;添加管理员</a>
        	<div class="row">
        		<div class="col-xs-12">
        			<div class="widget">
        					...
        					<table class="table table-hover table-bordered">
        						...
        						<tbody>
        							...
        							<tr userData="{{$vo->id}}">
        								...
        								<td>
        									@if(session('admin.is_super') == 1 && session('admin.id') != $vo->id && $vo->is_super != 1)
        										@if($vo->status == 1)
	        									...
	        									@endif
        									@endif
        									<a href="{{url('admin/adminedit',['id'=>$vo->id])}}" class="btn btn-azure btn-xs">编辑</a>
