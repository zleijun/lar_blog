    				...
    				<div class="widget-body">
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label for="catename" class="col-sm-2 control-label no-padding-right">管理员名称</label>
                                <div class="col-sm-6">
                                    <input type="text" readonly class="form-control" value="{{$admininfo->username}}" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="catename" class="col-sm-2 control-label no-padding-right">管理员昵称</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="nickname" value="{{$admininfo->nickname}}" placeholder="请输入管理员昵称" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="catename" class="col-sm-2 control-label no-padding-right">邮箱</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" disabled value="{{$admininfo->email}}" />
                                </div>
                            </div>
                            <div class="form-group">
